...
// Whitelist of allowed models for safety; extend as needed (removed , "codegemma:7b", "deepseek-r1:7b", "gpt-oss:20b")
const ALLOWED_MODELS = new Set(["qwen2:1.5b", "qwen3:1.7b", "qwen3:8b", "codegemma:2b"]);
